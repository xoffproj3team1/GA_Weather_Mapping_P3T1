...
metar_string=json.dumps(list(metar_data_df.T.to_dict().values()))       # https://stackoverflow.com/questions/39257147/convert-pandas-dataframe-to-json-format answer #10 Amir.S
...
# %% [markdown]
# __To retrieve TAF data__        (This code is working and will be used in a future release having additional features)
...
for i in range (a):
    ...
    if i<a-1:
        if airport_info_query_raw_df.iloc[i+1]["arpt_id"]!=airport_info_query_raw_df.iloc[i]["arpt_id"]:
            ...
            # print(f"k={k}, i={i}")    # Kept for future maintenance
            # print(popup_text)    # Kept for future maintenance
            first_row=True
            first_rwy=True
